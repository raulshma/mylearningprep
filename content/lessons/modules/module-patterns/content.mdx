...
- **Public interface** — Buttons you can press, coin slot, item dispenser
- **Private internals** — Motor, inventory tracking, money counter
...
A pizza shop doesn't give you raw ingredients — it creates pizzas based on your order. You say "pepperoni pizza" and get a complete pizza back!
...
**Watch out for circular dependencies!** If module A imports from the barrel, and the barrel imports from module A, you'll have problems. Keep barrel files simple — just re-exports!
</InfoBox>
...
```javascript
// ❌ This might import everything (bad for bundle size)
import * as UI from './components/ui';
UI.Button; // Only using Button, but might load all

// ✅ This allows tree-shaking (only imports what's used)
