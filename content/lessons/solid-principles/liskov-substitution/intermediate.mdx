...
public class Penguin : Bird
{
    ...
    { 
        // Do nothing ❌ - Violates expected behavior
    }
}
```
...
public class FileLogger : ILogger
{
    ...
    {
        throw new NotImplementedException();  // ❌ Breaks contract!
    }
}
```
...
- 🧪 **Test polymorphically** - All subtypes should pass parent's tests
</InfoBox>
