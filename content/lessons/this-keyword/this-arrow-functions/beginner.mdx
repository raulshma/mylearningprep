...
person.sayHiRegular(); // "Hi, I'm Alice" ✓
person.sayHiArrow();   // "Hi, I'm undefined" ✗
```

Wait, why is the arrow function broken? 🤔

<ThisKeywordVisualizer context="arrow" showStrictMode={false} />

## The Freezing Magic ❄️
...
## When NOT to Use Arrow Functions ⚠️

```javascript
// ❌ DON'T use arrows as object methods
const bad = {
  name: "Bad Example",
  greet: () => {
