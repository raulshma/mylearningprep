...
<ProgressCheckpoint section="intro-variables" xpReward={10} />

---

## Section 2: Numeric Types in Detail
...
<ProgressCheckpoint section="common-types" xpReward={10} />
...
<ProgressCheckpoint section="type-conversion" xpReward={10} />

---

## Section 4: Nullable Types
...
<InfoBox type="tip" title="Variable Best Practices">
...
<ProgressCheckpoint section="advanced-types" xpReward={10} />
