...
// Or use reflection-based discovery:
// StartupDevelopment, StartupProduction, etc.
```
...
## Environment in Docker and Kubernetes
...
<ProgressCheckpoint section="env-advanced" xpReward={55} />
