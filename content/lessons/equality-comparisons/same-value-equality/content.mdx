...
You've learned that `===` is great, but it has two quirks: `NaN !== NaN` and `+0 === -0`. Enter `Object.is()` — introduced in ES6 to provide the most mathematically correct equality comparison in JavaScript.
...
// Are these the "same"? Not really — they came from different operations
...
// ✅ Use findIndex with Object.is
values.findIndex(v => Object.is(v, NaN))  // 2

// ✅ Or use Number.isNaN() for simple checks
