...
> **Real-world examples:**
>
> - Students ↔ Classes (you take many, classes have many students)
> - Actors ↔ Movies (actors are in many movies, movies have many actors)
> - Products ↔ Categories
...
| :----------- | :------------ | :------------ | :----------------- |
| **1:1**      | Single entity | Single entity | Person ↔ Passport  |
| **1:N**      | Single entity | Collection    | Blog → Posts       |
| **N:N**      | Collection    | Collection    | Students ↔ Courses |
