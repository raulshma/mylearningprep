...
```csharp
// ❌ ANTI-PATTERN: Singleton capturing Scoped
...
| Circular Dependency        | A→B→A                          | Introduce mediator, lazy |
...
- 🧪 **WebApplicationFactory** - Replace services for integration testing
- 📦 **Module pattern** - Organize registrations into cohesive units
- 🔍 **Anti-pattern detection** - Know the smells and their fixes
- ⚠️ **Captive dependencies** - Use `IServiceScopeFactory` for scope management
