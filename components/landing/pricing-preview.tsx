...
const tiers = [
  ...
  },
  {
    ...
    features: ["25 interviews/month", "50 iterations/month", "Advanced analogies", "Export to PDF"],
  ...
  },
  {
    ...
    features: ["100 interviews/month", "500 iterations/month", "BYOK option", "API access"],
    cta: "Contact Us",
